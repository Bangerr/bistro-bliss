...
import aboutBackground from "~/assets/images/aboutMe-background.jpg";
import firstDishPicture from "~/assets/images/aboutPage-first.jpg";
import secondDishPicture from "~/assets/images/aboutPage-second.jpg";
</script>
